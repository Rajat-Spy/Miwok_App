...
//        words.add(new Word("Are you good?.", "Kuchi’: ’achin?", R.raw.are));
//        words.add(new Word("Me too.", "Kan:i’ ’echa’."));
//        words.add(new Word("I feel sorry for you.", "Kan:i’ ’eyangeṭ:in"));
//        words.add(new Word("My head hurts.", "Han:am sike˙:pana:t"));
